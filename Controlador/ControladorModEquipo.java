 ...
 */
@WebServlet(name = "ControladorModEquipo", urlPatterns = {"/ControladorModEquipo"})
public class ControladorModEquipo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean b = gt.modificarEquipo(t);
