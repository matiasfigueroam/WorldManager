 ...
 */
@WebServlet(name = "ControladorBorrEquipo", urlPatterns = {"/ControladorBorrEquipo"})
public class ControladorBorrEquipo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean b = gt.eliminarEquipo(id);
